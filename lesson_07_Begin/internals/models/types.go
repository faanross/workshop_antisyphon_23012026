...
// TODO: Define AgentTaskResult struct to hold the result of command execution
// This is what the agent sends back to the server after executing a command
// Hint: It should have:
//   - JobID (string) with json tag "job_id"
//   - Success (bool) with json tag "success"
